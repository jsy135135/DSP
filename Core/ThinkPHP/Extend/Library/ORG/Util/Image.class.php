...
class Image {
     ...
     * @return string
     */
    static function buildImageVerify($length=4, $mode=1, $type='png', $width=340, $height=46, $verifyName='verify') {
...
//        }
        ...
        for ($i = 0; $i < $length; $i++) {
            imagestring($im, 5, $i * 100 + 5, mt_rand(1, 8), $randval{$i}, $stringColor);
        }
        Image::output($im, $type);
    }

    // 中文验证码
    static function GBVerify($length=2, $type='png', $width=180, $height=50, $fontface='msyh.ttf.', $verifyName='verify') {
        import('ORG.Util.String');
